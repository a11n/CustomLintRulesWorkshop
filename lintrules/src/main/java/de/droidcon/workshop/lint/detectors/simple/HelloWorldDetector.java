 ...
 */
public class HelloWorldDetector extends Detector implements Detector.XmlScanner {

  public static final Issue ISSUE =
      Issue.create("HelloWorld",                               //ID
  ...
  @Override public void visitAttribute(@NonNull XmlContext context, @NonNull Attr attribute) {
    ...
    if (!TITLE.equals(value)) {
      context.report(ISSUE, attribute, context.getLocation(attribute),
          String.format("Unexpected title \"%1$s\". Should be \"Hello world.\".", value));
    }
  }
